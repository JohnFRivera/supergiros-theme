<div class="position-relative shadow rounded-1 mb-4">
    ...
    <img class="position-absolute top-0 start-50 translate-middle-x mt-4" src="<?php echo esc_url(supergiros_get_image_url('logo-chance.webp')) ?>" alt="Logo Chance" width="180px">
