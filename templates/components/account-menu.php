<div class="position-absolute end-0">
    ...
    if (is_user_logged_in()) {
        ...
        <div class="dropdown">
            <button class="hstack gap-2 bg-transparent border-0 text-light dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="vstack">
                    ...
                    <small class="text-start lh-1 opacity-50"><?php echo $user_role ?></small>
                </div>
            </button>
            <ul class="dropdown-menu dropdown-menu-end bg-light rounded-0 border-0 shadow mt-2 py-0">
                ...
                <li>
                    <a class="dropdown-item dropdown-danger" href="<?php echo wp_logout_url( home_url( 'ingresar' ) ); ?>">
        ...
        ?>
        <a class="btn btn-secondary rounded-1" href="<?php echo home_url( 'ingresar' ) ?>">
